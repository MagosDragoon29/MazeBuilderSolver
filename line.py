...
class Line:
    ...
    def draw(self, canvas, fill_color):
        canvas.canvas.create_line(self.point1.x, self.point1.y, self.point2.x, self.point2.y, fill=fill_color, width=2)
...
class Cell:
    ...
    def draw(self):
        ...
        if self.has_right_wall:
            Line(Point(self._x2, self._y1), Point(self._x2, self._y2)).draw(self._win, 'black')
